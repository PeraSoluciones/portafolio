...
-- El trigger on_auth_user_created se elimina porque depende del esquema auth
-- que no está disponible en la base de datos shadow de Prisma.
-- La lógica de handle_new_user se moverá al código de la aplicación.
