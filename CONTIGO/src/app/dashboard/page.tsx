      ...
      {selectedChild ? (
        <>
          ...
          <div className='mb-8'>
            ...
            <p className='text-muted-foreground mt-2'>
              Bienvenido/a a tu dashboard. Aquí puedes gestionar las rutinas,
              hábitos y comportamientos de {selectedChild.name}.
            </p>
          </div>
                ...
                <div className='space-y-4'>
                  <div className='p-4 bg-primary/5 rounded-lg border border-primary/10'>
                    ...
                    <p className='text-muted-foreground text-xs mt-1'>
                      Establece horarios consistentes para mejorar la
                      organización
                    </p>
                  </div>
        ...
        <div className='text-center py-16 max-w-2xl mx-auto'>
          ...
          <p className='text-muted-foreground mb-10 text-lg'>
            Para empezar, agrega a tus hijos y comienza a crear rutinas y
