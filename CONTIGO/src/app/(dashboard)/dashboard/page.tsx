      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-muted-foreground mt-1'>
            Gestiona las rutinas y actividades de{' '}
            {selectedChild?.name || 'tus hijos'}
          </p>
        </div>
            ...
            <CardContent className='flex-grow flex flex-col'>
                ...
                {[...Array(7)].map((_, i) => (
                  <div
                    ...
                    className={`h-2 flex-1 rounded-full ${
                      i < Math.min(habits.length, 7) ? 'bg-chart-5' : 'bg-muted'
                    }`}
                  ></div>
                ))}
              </div>
              <div className='mt-auto flex items-center justify-between'>
                ...
                <Link href='/habits/new'>
                  <Button
                    size='sm'
                    className='bg-chart-5 hover:bg-chart-5/90 text-chart-5-foreground transition-colors duration-200'
                  >
                    <Plus className='h-4 w-4 mr-2' />
                    Nuevo
                  </Button>
