    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="lg:w-1/2 flex items-center justify-center p-8 lg:p-12 bg-gray-50">
        <Card className="w-full max-w-md shadow-xl border-t-4 border-t-indigo-500">
          <CardHeader className="text-center space-y-2">
            <CardTitle className="text-2xl font-bold text-gray-900">Únete a CONTIGO</CardTitle>
            <CardDescription className="text-gray-600">
              Crea tu cuenta y empieza a transformar la gestión diaria con rutinas, hábitos y recompensas.
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-gray-50 px-2 text-muted-foreground">O regístrate con email</span>
              </div>
            </div>
          ...
          <CardFooter className="flex justify-center">
            <p className="text-sm text-gray-600">
              ¿Ya tienes cuenta?{' '}
              <Link href="/login" className="text-indigo-600 hover:underline font-medium transition-colors duration-200">
                Inicia sesión
              </Link>
            </p>
          </CardFooter>
