...
export const AuthVisual: React.FC = () => {
  return (
    <div className='lg:w-1/2 flex flex-col justify-center items-center p-8 lg:p-12 bg-linear-to-br from-[hsl(204,78%,43%)] to-[hsl(271,31%,44%)] text-white relative overflow-hidden'>
      ...
      <div
        className='absolute bottom-10 left-10 w-40 h-40 bg-white/5 rounded-full blur-2xl animate-pulse'
      ...
      <div className='max-w-md text-center space-y-6 relative z-10'>
        ...
        <div className='relative inline-block'>
          ...
          <div
            className='absolute inset-0 bg-white/10 rounded-full blur-lg scale-125 animate-pulse'
        ...
        <h1
          className='text-4xl lg:text-6xl font-bold tracking-tight drop-shadow-lg animate-fade-in-up'
        ...
        <p
          className='text-lg lg:text-xl opacity-95 drop-shadow-md max-w-sm mx-auto animate-fade-in-up'
        ...
        <div
          className='w-full h-64 lg:h-96 rounded-xl overflow-hidden shadow-2xl border-2 border-white/20 backdrop-blur-sm animate-fade-in-up'
